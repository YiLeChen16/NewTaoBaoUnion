...
public final class BaseLayoutBinding implements ViewBinding {
  ...
  private BaseLayoutBinding(@NonNull ConstraintLayout rootView, @NonNull FrameLayout baseLayout) {
  ...
  public static BaseLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new BaseLayoutBinding((ConstraintLayout) rootView, baseLayout);
    }
